...
TODO: merge this file with the file for classes analysis. 
"""
...
# Finding schools that do not have separate classes. 
...
datanames = [school for id, school in enumerate(datanames) if id in schools_to_keep]
...
get_quasilevels_from_multiple_files(in_files, out_files, merge_to_one = False, 
                                    ...
                                    get_quasilevels_fun = get_quasilevels2_early20,
