...
dataset = "/home/pgorski/Desktop/data/bitcoin-alpha/bit_alpha.csv"
rel_fname = "../data/bitcoin-alpha/bit_alpha.csv"
...
if what == "rho_inits2":
    ...
    silent = True
if what == "rho_inits3":
    foldername = "outputs/bitcoin-alpha-rhoinits-triads-reps"
    ...
    sim_sets = [(0.1, 0.8, 0.1, 0.6), (0.2, 0.8, 0.9, 0.6), (0.3, 0.8, 0.5, 0.6), (0.4, 0.8, 0.6000000000000001, 0.8), 
                (0.5, 0.6000000000000001, 0.9, 0.4), (0.5, 0.7000000000000001, 0.7000000000000001, 0.8), (0.5, 0.8, 0.5, 0.6), (0.6, 0.4, 1.0, 0.2), 
                (0.6, 0.7000000000000001, 0.7000000000000001, 0.0), (0.8, 0.0, 1.0, 0.9), (0.8, 0.1, 1.0, 0.4), (0.8, 0.5, 0.8, 0.6), 
                (0.8, 0.6000000000000001, 0.8, 0.6), (0.8, 0.8, 0.6000000000000001, 0.6), (0.8, 0.9, 0.5, 0.2), (0.8, 1.0, 0.4, 0.8), 
                (0.9, 0.0, 0.9, 0.2), (0.9, 0.1, 1.0, 0.6), (0.9, 0.2, 0.7000000000000001, 0.0), (0.9, 0.2, 0.8, 0.2), (0.9, 0.2, 0.8, 0.6), 
                (0.9, 0.2, 0.9, 0.4), (0.9, 0.2, 1.0, 0.4), (0.9, 0.3, 0.9, 0.4), (0.9, 0.3, 1.0, 0.2), (0.9, 0.3, 1.0, 0.6), (0.9, 0.4, 0.8, 0.2), 
                (0.9, 0.4, 0.8, 0.4), (0.9, 0.9, 0.7000000000000001, 0.0), (0.9, 1.0, 0.5, 0.0), (0.9, 1.0, 0.5, 0.4), 
                (1.0, 0.5, 0.6000000000000001, 0.0), (1.0, 0.5, 0.6000000000000001, 0.2), (1.0, 0.5, 0.6000000000000001, 0.4), 
                (1.0, 0.5, 0.6000000000000001, 0.6), (1.0, 0.5, 0.6000000000000001, 0.8), (1.0, 0.5, 0.7000000000000001, 0.0), 
                (1.0, 0.5, 0.7000000000000001, 0.2), (1.0, 0.5, 0.7000000000000001, 0.4), (1.0, 0.5, 0.7000000000000001, 0.6), 
                (1.0, 0.5, 0.7000000000000001, 0.8), (1.0, 0.5, 0.8, 0.0), 
                (1.0, 0.5, 0.8, 0.2), (1.0, 0.5, 0.8, 0.4), (1.0, 0.5, 0.8, 0.6), (1.0, 0.5, 0.8, 0.8), (1.0, 0.5, 0.9, 0.0), (1.0, 0.5, 0.9, 0.2), 
                (1.0, 0.5, 0.9, 0.4), (1.0, 0.5, 0.9, 0.8), (1.0, 0.5, 1.0, 0.0), (1.0, 0.5, 1.0, 0.2), (1.0, 0.5, 1.0, 0.4), (1.0, 0.5, 1.0, 0.6)
                 ]
    ...
    foldername = "outputs/bitcoin-alpha-triads-test"
