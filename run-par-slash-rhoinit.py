# This file was used to create simulations of ABM on Slashdot dataset assuming varying initial positive link density. 
...
if what == "rho_inits2":
    foldername = "outputs/slash-rhoinits-triads"
    ...
    foldername = "outputs/slash-rhoinits-triads2"
    
    sim_sets = [[[0.9,], 
                 [0.5, 0.6, 0.7, 0.8, 0.9, 1.0], [0, 0.1, 0.2, 0.3]], 
                 ]
    ...
    sim_sets = [[[0.825], 
                 [0.5, 0.6, 0.7, 0.8, 0.9, 1.0], [0, 0.1, 0.2, 0.3]], 
                [[0.925], [0.4, 0.5, 0.6, 0.7], [0.4, 0.5] ], 
                [[0.95], [0.4, 0.5, 0.6, 0.7], [0.2, 0.3, 0.4, 0.5] ], 
                 ]
...
elif what in ["rho_inits2", "rho_inits3", "rho_inits32", "test_run"]:
    exp_sets = explode_sims(sim_sets)
